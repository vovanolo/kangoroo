...
function Principles() {
  return (
    <article id="Principles">
      <div className="flex flex-col items-center text-7xl text-center p-10">
        <p>Чому батьки</p>
        <p>обирають Кенгуру ?</p>
      </div>
      ...
      <div className="flex flex-wrap gap-y-8 mt-10 container mx-auto">
        {data.map(({ key, source, label }) => (
          <div
            key={key}
            className="flex flex-col items-center text-center w-full sm:w-1/2 lg:w-4/12"
          >
            <div>
